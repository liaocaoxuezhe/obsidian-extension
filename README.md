...
## Pricing and network disclosure

Analogy is free to install and can index up to 1000 Markdown pages for free. Optional payments can unlock higher indexing limits.

Payments are handled outside Obsidian through the project website or a configured Stripe Checkout link. Obsidian Community does not process payments for this plugin.
