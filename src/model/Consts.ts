...
export const WaitLogin: string = "wait_login"
export const Logging: string = "logging"
export const WaitAuthVault: string = "wait_auth_vault"
export const VaultAuthing: string = "vault_authing"
export const LoginFinished: string = "login_finished"

export const IsAuthVault: number = 0
export const NotAuthVault: number = 1

export const LoginStatusList: string[] = [WaitLogin, Logging]
export const AuthVaultStatusList: string[] = [WaitAuthVault, VaultAuthing]

export const icon: string = `<g transform="scale(2.08333)" fill="none" stroke="none">
